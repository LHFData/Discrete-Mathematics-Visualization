      ...
      <Layout className="containAll">
        <Sider collapsible collapsed={collapsed} onCollapse={this.onCollapse}>
          {theme === 'light' ? (
            ...
            >
              <Icon type="deployment-unit" className="github" />
            </a>
          ) : (
            <a
              href="https://github.com/MuYunyun/react-antd-demo"
              ...
              rel="noopener noreferrer"
            >
              <Icon type="deployment-unit" className="github white" />
            </a>
          )}
          {theme === 'light' ? (
            <span className="author">BUPT-SSE</span>
          ) : (
            <span className="author white">BUPT-SSE</span>
          )}
          <Menu
            theme={theme}
